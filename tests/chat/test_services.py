...
class TestChatService:
    ...
    async def test_get_or_create_session_for_project_returns_existing_session(self, chat_service, session_service_mock):
    ...
    async def test_get_or_create_session_for_project_creates_new_session_if_none_exist(self, chat_service, session_service_mock):
    ...
    async def test_add_ai_message_creates_message_with_assistant_role(self, chat_service, message_repository_mock):
    ...
    async def test_get_chat_history_returns_llama_index_chat_messages(self, chat_service, message_repository_mock):
    ...
    async def test_get_session_by_id_delegates_to_session_service(self, chat_service, session_service_mock):
    ...
    async def test_list_messages_by_session_delegates_to_repo(self, chat_service, message_repository_mock):
    ...
    async def test_save_messages_for_turn_saves_user_then_ai_message(self, chat_service, message_repository_mock):
        ...
        await chat_service.save_messages_for_turn(
            session_id=1, turn_id="t1", user_content="u", blocks=[{"type": "text", "content": "a"}]
        )
        assert message_repository_mock.create.call_count == 2

    async def test_clear_session_messages_calls_repository_delete(self, chat_service, message_repository_mock):
...
class TestChatTurnService:
    async def test_start_turn_generates_turn_id_and_creates_pending_turn_when_turn_id_is_none(self, chat_turn_service, chat_turn_repository_mock):
    ...
    async def test_start_turn_raises_when_retry_turn_not_found(self, chat_turn_service, chat_turn_repository_mock):
    ...
    async def test_start_turn_raises_when_turn_already_succeeded(self, chat_turn_service, chat_turn_repository_mock):
    ...
    async def test_start_turn_returns_existing_turn_id_when_turn_exists_and_not_succeeded(self, chat_turn_service, chat_turn_repository_mock):
    ...
    async def test_mark_succeeded_raises_when_turn_missing(self, chat_turn_service, chat_turn_repository_mock):
    ...
    async def test_mark_succeeded_updates_turn_status_to_succeeded(self, chat_turn_service, chat_turn_repository_mock):
